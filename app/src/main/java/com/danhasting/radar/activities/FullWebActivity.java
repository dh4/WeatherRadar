...
import com.danhasting.radar.fragments.FullWebFragment;

import java.util.concurrent.CompletableFuture;


public class FullWebActivity extends MainActivity implements RadarMenu.Ui {
    private RadarMenu radarMenu;

    private String location;
    private Source source;

    private FullWebFragment fullWebFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (inflater != null) {
            View contentView = inflater.inflate(R.layout.activity_full_web, drawerLayout, false);
        ...
        fullWebFragment = new FullWebFragment();
        fullWebFragment.setArguments(intent.getExtras());
        getSupportFragmentManager().beginTransaction()
                .replace(R.id.fragment_container, fullWebFragment).commit();
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (extras != null) {
            Intent newIntent = new Intent(this, FullWebActivity.class);
    ...
    public void refreshRadar() {
        if (fullWebFragment != null) fullWebFragment.refreshWebView("");
    }
    ...
    @Override public String getLocation() {
        return fullWebFragment != null ? fullWebFragment.getCurrentSettings() : null;
    }
    ...
    @Override public CompletableFuture<String> getCurrentLocationNameAsync() {
        return fullWebFragment != null ? fullWebFragment.getCurrentLocationNameAsync() : null;
    }
}
